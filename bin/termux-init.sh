...
yes | pkg upgrade
yes | pkg install game-repo science-repo root-repo x11-repo termux-keyring termux-api termux-exec fakeroot git curl which proot proot-distro pulseaudio termux-x11-nightly
