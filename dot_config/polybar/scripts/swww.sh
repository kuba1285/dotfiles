...
WALLPAPERS=("$WALLPAPER_DIR"/*.jpg "$WALLPAPER_DIR"/*.jpeg "$WALLPAPER_DIR"/*.png)
...
swww img "${WALLPAPERS[$NEXT_INDEX]}" --transition-type outer --transition-angle 30 --transition-step 90
